...
modules.Clock = (function() {
    ...
    function Clock() {
        ...
        window.onload = function () {
            ...
            window.setInterval(self.paintClockHands, 1000);
            self.pendulum();
        };
    }

    Clock.prototype.pendulum = function() {
        var sin = Math.sin;
        var cos = Math.cos;
    ...
    Clock.prototype.paintClockHands = function() {
    ...
    Clock.prototype.paintClockFace = function() {
        var x0 = 210;
        var y0 = 210;
        var R = 200;
        var k;
